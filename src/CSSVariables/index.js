...
class CssVariables extends React.Component {
    constructor(props) {
        ...
        this.handleBlur = this
            .handleBlur
            .bind(this);
        this.handleColor = this
            .handleColor
            .bind(this);
        this.handleSpacing = this
            .handleSpacing
            .bind(this);
        this.state = {
            spacing: 0,
    ...
    handleSpacing(e) {
        ...
        document
            .documentElement
            .style
            .setProperty(`--spacing`, e.target.value + 'px');
    }
    handleBlur(e) {
        e.preventDefault();
        console.log(e.target.value);
        ...
        document
            .documentElement
            .style
            .setProperty(`--blur`, e.target.value + 'px');
    }
    handleColor(e) {
        // e.preventDefault();
        console.log(e.target.value);
        ...
        document
            .documentElement
            .style
            .setProperty(`--base`, e.target.value);
    }
    render() {
        return (
